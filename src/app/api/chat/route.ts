...
המשלוח: 30 ₪, חינם מעל 250 ₪. זמן הגעה: 10-17 ימי עסקים.
...
const FAQ: Record<string, string> = {
  shipping:
    "המשלוחים מגיעים תוך 10-17 ימי עסקים מרגע אישור התשלום. כל חולצה נתפרת לפי הזמנה — זה הזמן שלוקח לייצר ולשלוח. מחיר משלוח 30 ₪, חינם מעל 250 ₪. תקבל אישור הזמנה ומספר מעקב למייל ולוואטסאפ ברגע שהמשלוח יוצא.",
  returns:
